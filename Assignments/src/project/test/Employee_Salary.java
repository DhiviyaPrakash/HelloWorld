...
public class Employee_Salary {
	...
	public static void main(String args[])
	{
		...
		es.getData();
		es.new Employee_Salary2().calculate_hra_pf(basicPay,deduction,bonus);
		es.new Employee_Salary3().totalSalary(basicPay,hra,pf,deduction,bonus);
	}
